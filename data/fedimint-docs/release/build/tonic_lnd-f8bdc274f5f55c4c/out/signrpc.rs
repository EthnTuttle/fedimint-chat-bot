...
pub struct SignMessageReq {
    ...
    pub schnorr_sig_tap_tweak: ::prost::alloc::vec::Vec<u8>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
# [doc = r" Generated client implementations."] pub mod signer_client { # ! [allow (unused_variables , dead_code , missing_docs , clippy :: let_unit_value ,)] use tonic :: codegen :: * ; # [doc = " Signer is a service that gives access to the signing functionality of the"] # [doc = " daemon's wallet."] # [derive (Debug , Clone)] pub struct SignerClient < T > { inner : tonic :: client :: Grpc < T > , } impl SignerClient < tonic :: transport :: Channel > { # [doc = r" Attempt to create a new client by connecting to a given endpoint."] pub async fn connect < D > (dst : D) -> Result < Self , tonic :: transport :: Error > where D : std :: convert :: TryInto < tonic :: transport :: Endpoint > , D :: Error : Into < StdError > , { let conn = tonic :: transport :: Endpoint :: new (dst) ? . connect () . await ? ; Ok (Self :: new (conn)) } } impl < T > SignerClient < T > where T : tonic :: client :: GrpcService < tonic :: body :: BoxBody > , T :: ResponseBody : Body + Send + Sync + 'static , T :: Error : Into < StdError > , < T :: ResponseBody as Body > :: Error : Into < StdError > + Send , { pub fn new (inner : T) -> Self { let inner = tonic :: client :: Grpc :: new (inner) ; Self { inner } } pub fn with_interceptor < F > (inner : T , interceptor : F) -> SignerClient < InterceptedService < T , F >> where F : tonic :: service :: Interceptor , T : tonic :: codegen :: Service < http :: Request < tonic :: body :: BoxBody > , Response = http :: Response << T as tonic :: client :: GrpcService < tonic :: body :: BoxBody >> :: ResponseBody > > , < T as tonic :: codegen :: Service < http :: Request < tonic :: body :: BoxBody >> > :: Error : Into < StdError > + Send + Sync , { SignerClient :: new (InterceptedService :: new (inner , interceptor)) } # [doc = r" Compress requests with `gzip`."] # [doc = r""] # [doc = r" This requires the server to support it otherwise it might respond with an"] # [doc = r" error."] pub fn send_gzip (mut self) -> Self { self . inner = self . inner . send_gzip () ; self } # [doc = r" Enable decompressing responses with `gzip`."] pub fn accept_gzip (mut self) -> Self { self . inner = self . inner . accept_gzip () ; self } # [doc = ""] # [doc = "SignOutputRaw is a method that can be used to generated a signature for a"] # [doc = "set of inputs/outputs to a transaction. Each request specifies details"] # [doc = "concerning how the outputs should be signed, which keys they should be"] # [doc = "signed with, and also any optional tweaks. The return value is a fixed"] # [doc = "64-byte signature (the same format as we use on the wire in Lightning)."] # [doc = ""] # [doc = "If we are  unable to sign using the specified keys, then an error will be"] # [doc = "returned."] pub async fn sign_output_raw (& mut self , request : impl tonic :: IntoRequest < super :: SignReq > ,) -> Result < tonic :: Response < super :: SignResp > , tonic :: Status > { self . inner . ready () . await . map_err (| e | { tonic :: Status :: new (tonic :: Code :: Unknown , format ! ("Service was not ready: {}" , e . into ())) }) ? ; let codec = tonic :: codec :: ProstCodec :: default () ; let path = http :: uri :: PathAndQuery :: from_static ("/signrpc.Signer/SignOutputRaw") ; self . inner . unary (request . into_request () , path , codec) . await } # [doc = ""] # [doc = "ComputeInputScript generates a complete InputIndex for the passed"] # [doc = "transaction with the signature as defined within the passed SignDescriptor."] # [doc = "This method should be capable of generating the proper input script for both"] # [doc = "regular p2wkh/p2tr outputs and p2wkh outputs nested within a regular p2sh"] # [doc = "output."] # [doc = ""] # [doc = "Note that when using this method to sign inputs belonging to the wallet,"] # [doc = "the only items of the SignDescriptor that need to be populated are pkScript"] # [doc = "in the TxOut field, the value in that same field, and finally the input"] # [doc = "index."] pub async fn compute_input_script (& mut self , request : impl tonic :: IntoRequest < super :: SignReq > ,) -> Result < tonic :: Response < super :: InputScriptResp > , tonic :: Status > { self . inner . ready () . await . map_err (| e | { tonic :: Status :: new (tonic :: Code :: Unknown , format ! ("Service was not ready: {}" , e . into ())) }) ? ; let codec = tonic :: codec :: ProstCodec :: default () ; let path = http :: uri :: PathAndQuery :: from_static ("/signrpc.Signer/ComputeInputScript") ; self . inner . unary (request . into_request () , path , codec) . await } # [doc = ""] # [doc = "SignMessage signs a message with the key specified in the key locator. The"] # [doc = "returned signature is fixed-size LN wire format encoded."] # [doc = ""] # [doc = "The main difference to SignMessage in the main RPC is that a specific key is"] # [doc = "used to sign the message instead of the node identity private key."] pub async fn sign_message (& mut self , request : impl tonic :: IntoRequest < super :: SignMessageReq > ,) -> Result < tonic :: Response < super :: SignMessageResp > , tonic :: Status > { self . inner . ready () . await . map_err (| e | { tonic :: Status :: new (tonic :: Code :: Unknown , format ! ("Service was not ready: {}" , e . into ())) }) ? ; let codec = tonic :: codec :: ProstCodec :: default () ; let path = http :: uri :: PathAndQuery :: from_static ("/signrpc.Signer/SignMessage") ; self . inner . unary (request . into_request () , path , codec) . await } # [doc = ""] # [doc = "VerifyMessage verifies a signature over a message using the public key"] # [doc = "provided. The signature must be fixed-size LN wire format encoded."] # [doc = ""] # [doc = "The main difference to VerifyMessage in the main RPC is that the public key"] # [doc = "used to sign the message does not have to be a node known to the network."] pub async fn verify_message (& mut self , request : impl tonic :: IntoRequest < super :: VerifyMessageReq > ,) -> Result < tonic :: Response < super :: VerifyMessageResp > , tonic :: Status > { self . inner . ready () . await . map_err (| e | { tonic :: Status :: new (tonic :: Code :: Unknown , format ! ("Service was not ready: {}" , e . into ())) }) ? ; let codec = tonic :: codec :: ProstCodec :: default () ; let path = http :: uri :: PathAndQuery :: from_static ("/signrpc.Signer/VerifyMessage") ; self . inner . unary (request . into_request () , path , codec) . await } # [doc = ""] # [doc = "DeriveSharedKey returns a shared secret key by performing Diffie-Hellman key"] # [doc = "derivation between the ephemeral public key in the request and the node's"] # [doc = "key specified in the key_desc parameter. Either a key locator or a raw"] # [doc = "public key is expected in the key_desc, if neither is supplied, defaults to"] # [doc = "the node's identity private key:"] # [doc = "P_shared = privKeyNode * ephemeralPubkey"] # [doc = "The resulting shared public key is serialized in the compressed format and"] # [doc = "hashed with sha256, resulting in the final key length of 256bit."] pub async fn derive_shared_key (& mut self , request : impl tonic :: IntoRequest < super :: SharedKeyRequest > ,) -> Result < tonic :: Response < super :: SharedKeyResponse > , tonic :: Status > { self . inner . ready () . await . map_err (| e | { tonic :: Status :: new (tonic :: Code :: Unknown , format ! ("Service was not ready: {}" , e . into ())) }) ? ; let codec = tonic :: codec :: ProstCodec :: default () ; let path = http :: uri :: PathAndQuery :: from_static ("/signrpc.Signer/DeriveSharedKey") ; self . inner . unary (request . into_request () , path , codec) . await } # [doc = ""] # [doc = "MuSig2CombineKeys (experimental!) is a stateless helper RPC that can be used"] # [doc = "to calculate the combined MuSig2 public key from a list of all participating"] # [doc = "signers' public keys. This RPC is completely stateless and deterministic and"] # [doc = "does not create any signing session. It can be used to determine the Taproot"] # [doc = "public key that should be put in an on-chain output once all public keys are"] # [doc = "known. A signing session is only needed later when that output should be"] # [doc = "_spent_ again."] # [doc = ""] # [doc = "NOTE: The MuSig2 BIP is not final yet and therefore this API must be"] # [doc = "considered to be HIGHLY EXPERIMENTAL and subject to change in upcoming"] # [doc = "releases. Backward compatibility is not guaranteed!"] pub async fn mu_sig2_combine_keys (& mut self , request : impl tonic :: IntoRequest < super :: MuSig2CombineKeysRequest > ,) -> Result < tonic :: Response < super :: MuSig2CombineKeysResponse > , tonic :: Status > { self . inner . ready () . await . map_err (| e | { tonic :: Status :: new (tonic :: Code :: Unknown , format ! ("Service was not ready: {}" , e . into ())) }) ? ; let codec = tonic :: codec :: ProstCodec :: default () ; let path = http :: uri :: PathAndQuery :: from_static ("/signrpc.Signer/MuSig2CombineKeys") ; self . inner . unary (request . into_request () , path , codec) . await } # [doc = ""] # [doc = "MuSig2CreateSession (experimental!) creates a new MuSig2 signing session"] # [doc = "using the local key identified by the key locator. The complete list of all"] # [doc = "public keys of all signing parties must be provided, including the public"] # [doc = "key of the local signing key. If nonces of other parties are already known,"] # [doc = "they can be submitted as well to reduce the number of RPC calls necessary"] # [doc = "later on."] # [doc = ""] # [doc = "NOTE: The MuSig2 BIP is not final yet and therefore this API must be"] # [doc = "considered to be HIGHLY EXPERIMENTAL and subject to change in upcoming"] # [doc = "releases. Backward compatibility is not guaranteed!"] pub async fn mu_sig2_create_session (& mut self , request : impl tonic :: IntoRequest < super :: MuSig2SessionRequest > ,) -> Result < tonic :: Response < super :: MuSig2SessionResponse > , tonic :: Status > { self . inner . ready () . await . map_err (| e | { tonic :: Status :: new (tonic :: Code :: Unknown , format ! ("Service was not ready: {}" , e . into ())) }) ? ; let codec = tonic :: codec :: ProstCodec :: default () ; let path = http :: uri :: PathAndQuery :: from_static ("/signrpc.Signer/MuSig2CreateSession") ; self . inner . unary (request . into_request () , path , codec) . await } # [doc = ""] # [doc = "MuSig2RegisterNonces (experimental!) registers one or more public nonces of"] # [doc = "other signing participants for a session identified by its ID. This RPC can"] # [doc = "be called multiple times until all nonces are registered."] # [doc = ""] # [doc = "NOTE: The MuSig2 BIP is not final yet and therefore this API must be"] # [doc = "considered to be HIGHLY EXPERIMENTAL and subject to change in upcoming"] # [doc = "releases. Backward compatibility is not guaranteed!"] pub async fn mu_sig2_register_nonces (& mut self , request : impl tonic :: IntoRequest < super :: MuSig2RegisterNoncesRequest > ,) -> Result < tonic :: Response < super :: MuSig2RegisterNoncesResponse > , tonic :: Status > { self . inner . ready () . await . map_err (| e | { tonic :: Status :: new (tonic :: Code :: Unknown , format ! ("Service was not ready: {}" , e . into ())) }) ? ; let codec = tonic :: codec :: ProstCodec :: default () ; let path = http :: uri :: PathAndQuery :: from_static ("/signrpc.Signer/MuSig2RegisterNonces") ; self . inner . unary (request . into_request () , path , codec) . await } # [doc = ""] # [doc = "MuSig2Sign (experimental!) creates a partial signature using the local"] # [doc = "signing key that was specified when the session was created. This can only"] # [doc = "be called when all public nonces of all participants are known and have been"] # [doc = "registered with the session. If this node isn't responsible for combining"] # [doc = "all the partial signatures, then the cleanup flag should be set, indicating"] # [doc = "that the session can be removed from memory once the signature was produced."] # [doc = ""] # [doc = "NOTE: The MuSig2 BIP is not final yet and therefore this API must be"] # [doc = "considered to be HIGHLY EXPERIMENTAL and subject to change in upcoming"] # [doc = "releases. Backward compatibility is not guaranteed!"] pub async fn mu_sig2_sign (& mut self , request : impl tonic :: IntoRequest < super :: MuSig2SignRequest > ,) -> Result < tonic :: Response < super :: MuSig2SignResponse > , tonic :: Status > { self . inner . ready () . await . map_err (| e | { tonic :: Status :: new (tonic :: Code :: Unknown , format ! ("Service was not ready: {}" , e . into ())) }) ? ; let codec = tonic :: codec :: ProstCodec :: default () ; let path = http :: uri :: PathAndQuery :: from_static ("/signrpc.Signer/MuSig2Sign") ; self . inner . unary (request . into_request () , path , codec) . await } # [doc = ""] # [doc = "MuSig2CombineSig (experimental!) combines the given partial signature(s)"] # [doc = "with the local one, if it already exists. Once a partial signature of all"] # [doc = "participants is registered, the final signature will be combined and"] # [doc = "returned."] # [doc = ""] # [doc = "NOTE: The MuSig2 BIP is not final yet and therefore this API must be"] # [doc = "considered to be HIGHLY EXPERIMENTAL and subject to change in upcoming"] # [doc = "releases. Backward compatibility is not guaranteed!"] pub async fn mu_sig2_combine_sig (& mut self , request : impl tonic :: IntoRequest < super :: MuSig2CombineSigRequest > ,) -> Result < tonic :: Response < super :: MuSig2CombineSigResponse > , tonic :: Status > { self . inner . ready () . await . map_err (| e | { tonic :: Status :: new (tonic :: Code :: Unknown , format ! ("Service was not ready: {}" , e . into ())) }) ? ; let codec = tonic :: codec :: ProstCodec :: default () ; let path = http :: uri :: PathAndQuery :: from_static ("/signrpc.Signer/MuSig2CombineSig") ; self . inner . unary (request . into_request () , path , codec) . await } # [doc = ""] # [doc = "MuSig2Cleanup (experimental!) allows a caller to clean up a session early in"] # [doc = "cases where it's obvious that the signing session won't succeed and the"] # [doc = "resources can be released."] # [doc = ""] # [doc = "NOTE: The MuSig2 BIP is not final yet and therefore this API must be"] # [doc = "considered to be HIGHLY EXPERIMENTAL and subject to change in upcoming"] # [doc = "releases. Backward compatibility is not guaranteed!"] pub async fn mu_sig2_cleanup (& mut self , request : impl tonic :: IntoRequest < super :: MuSig2CleanupRequest > ,) -> Result < tonic :: Response < super :: MuSig2CleanupResponse > , tonic :: Status > { self . inner . ready () . await . map_err (| e | { tonic :: Status :: new (tonic :: Code :: Unknown , format ! ("Service was not ready: {}" , e . into ())) }) ? ; let codec = tonic :: codec :: ProstCodec :: default () ; let path = http :: uri :: PathAndQuery :: from_static ("/signrpc.Signer/MuSig2Cleanup") ; self . inner . unary (request . into_request () , path , codec) . await } } }